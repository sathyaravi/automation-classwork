...
public class EditLeadUsingXpath {
	...
	public  void editLead() {
		...
		driver.findElement(By.xpath("//input[@id='createLeadForm_companyName']")).sendKeys("TestLeaf112");
		driver.findElement(By.xpath("//input[@id='createLeadForm_firstName']")).sendKeys("Stacy1");
		driver.findElement(By.xpath("//input[@id='createLeadForm_lastName']")).sendKeys("William11");
